		 ...
		 // Tabela Price
          ...
          let simuladorA = new financiar(valor, taxa, parcelas)
              ...
              simuladorA.tratarDados()
                $("#resultado").html("")
				$("#tabelaPrice").html("")
                $("#resultado").append("<h2>Cálculo do seu financiamento Price</h2><br>")
				$("#tabelaPrice").append("<br>")
                $("#tabelaPrice").append("<span class='tabelaPrice-p'>Valor da Prestação ------------</span>" + "            " + simuladorA.calculoPRICE()+"<br>")
                $("#tabelaPrice").append("<span class='tabelaPrice-p'>Valor Total do Financiamento --</span>" + "  " + simuladorA.totalPrice()+"<br>")
                $("#tabelaPrice").append("<span class='tabelaPrice-p'>Valor Total de Juros -----------</span>" + "          " + simuladorA.totalJurosPrice()+"<br><br>")
				
				//Tabela SAC

                $("#resultado2").append("<h2>Sua tabela SAC</h2>")
         let simuladorB = new financiar(valor, taxa, parcelas)
             simuladorB.tratarString()
             simuladorB.tratarDados()
             simuladorB.calculoSAC()
                $("#tabelaSac").append("<br><br><div class='parcelas-sac'><h2 class='h2-sac'>Os Valores das Prestações são: </h2><br>"+simuladorB.listaSAChtml+"</div><br>")
                $("#tabelaSac2").append("Valor Total do Financiamento Pago é: "+simuladorB.totalSAC())
                $("#tabelaSac2").append("Valor Total de Juros Pago é: "+simuladorB.totalJurosSAC())
       }else{
